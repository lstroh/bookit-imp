...
(function () {
	...
	var defaultLabel = '<?php echo esc_js( __( 'Confirm Cancellation', 'bookit-booking-system' ) ); ?>';
	...
	btn.addEventListener('click', function () {
		...
		.then(function (data) {
			...
			if (data.success) {
				...
				msg.textContent = data.message || '<?php echo esc_js( __( 'Your booking has been cancelled.', 'bookit-booking-system' ) ); ?>';
