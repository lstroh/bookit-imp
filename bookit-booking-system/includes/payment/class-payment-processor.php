...
class Booking_System_Payment_Processor {
	...
	public function process_payment() {
		...
		$selected_existing_package_id = isset( $_POST['bookit_selected_existing_package_id'] ) ? absint( wp_unslash( $_POST['bookit_selected_existing_package_id'] ) ) : 0;
		...
		if ( $selected_existing_package_id > 0 ) {
			$session_data['customer_package_id'] = $selected_existing_package_id;
			Bookit_Session_Manager::set_data( $session_data );
		}
