...
class Test_Booking_Shortcode extends WP_UnitTestCase {
	...
	/**
	 * Test that 'bookit_my_packages' shortcode is registered.
	 *
	 * @covers Bookit_Shortcodes::__construct
	 */
	...
	/**
	 * Test that my packages shortcode renders email form when no email provided.
	 *
	...
	/**
	 * Test that my packages shortcode shows disabled message when packages are off.
	 *
	 * @covers Bookit_Shortcodes::render_my_packages
	 */
	...
	/**
	 * Test that my packages CSS enqueues on page with shortcode.
	 *
	 * @covers Bookit_Shortcodes::enqueue_wizard_assets
	 */
	public function test_my_packages_css_enqueued_only_on_my_packages_page() {
	...
	/**
	 * Test that my packages CSS is not enqueued on unrelated page.
	 *
	 * @covers Bookit_Shortcodes::enqueue_wizard_assets
	 */
