...
/**
 * Test class for REST API route registration and HTTP method restrictions for refresh endpoint.
 */
class Test_Auth_Refresh_Route extends \WP_UnitTestCase
{
    /**
    ...
    public function test_route_exists_at_expected_path(): void
    {
        ...
        $expected_route = '/bookit/v1/auth/refresh';
        ...
        $this->assertTrue(
            $route_exists,
            'Route should be registered at /bookit/v1/auth/refresh'
        );
    }
    ...
    public function test_only_post_method_is_allowed(): void
    {
        ...
        $this->assertContains(
            'POST',
            $allowed_methods,
            'POST method should be allowed for /bookit/v1/auth/refresh'
        );
        ...
        $this->assertNotContains(
            'GET',
            $allowed_methods,
            'GET method should not be allowed for /bookit/v1/auth/refresh'
        );
        
        // PUT should NOT be in the allowed methods
        $this->assertNotContains(
            'PUT',
            $allowed_methods,
            'PUT method should not be allowed for /bookit/v1/auth/refresh'
        );
        ...
        $this->assertNotContains(
            'DELETE',
            $allowed_methods,
            'DELETE method should not be allowed for /bookit/v1/auth/refresh'
        );
    }

    /**
     * Test that the route does not require JWT authentication.
     */
    public function test_route_does_not_require_jwt_auth(): void
    {
